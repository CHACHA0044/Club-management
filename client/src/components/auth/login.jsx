...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      navigate(role === "organizer" || role === "admin" ? "/organizer" : "/events");
    } catch (err) {
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden" aria-hidden>
        <div className="absolute top-20 left-10 w-72 h-72 bg-blue-500 rounded-full blur-3xl opacity-15" />
        <div className="absolute bottom-10 right-10 w-64 h-64 bg-blue-400 rounded-full blur-3xl opacity-10" />
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 pt-20 pb-10 relative z-10">
        <ScrollReveal className="w-full max-w-md">
          <div className="glass-card p-8 sm:p-10">
            ...
            {error && (
              <div
                className="mb-5 px-4 py-3 rounded-xl text-sm text-red-300 fade-up"
            ...
            {/* Footer */}
            <div
              className="mt-7 pt-6 text-center fade-up d4"
